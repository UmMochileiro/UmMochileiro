...
<head>
  ...
  <style>
    ...
    .skills h2, .languages h2, .education h2 {
      font-size: 18px;
      border-bottom: 2px solid #eaeaea;
      padding-bottom: 5px;
    }
    .skills ul, .languages ul, .education ul {
      list-style: none;
      padding: 0;
    }
    .skills ul li, .languages ul li, .education ul li {
      margin: 10px 0;
    }
    .social-media {
      margin-top: 20px;
  ...
  <div class="container">
    <div class="profile-card">
      ...
      <div class="skills">
        <h2>Skills</h2>
        <ul>
          <li> Ruby On Rails - 3 Months</li>
          <li> JavaScript - 6 Months</li>
          <li> HTML & CSS - 6 Months</li>
        </ul>
      </div>
      <div class="languages">
        <h2>Languages</h2>
